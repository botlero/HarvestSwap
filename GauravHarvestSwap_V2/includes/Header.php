...
<div class="navbar">
  ...
  <a href="#"><i class="fas fa-people-arrows"></i> SwapCenter</a> 
  <a href="#"><i class="fa fa-fw fa-address-card"></i> My Profile</a>
  <a href="createAccount.php"><i class="fa fa-fw fa-user"></i> Create Account</a>
  <a href="login.php"><i class="fa fa-fw fa-key"></i> Login</a>
  <a href="login.php"><i class="fa fa-fw fa-key"></i> Logout</a>
</div>
</header>
