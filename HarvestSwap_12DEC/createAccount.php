...
function validateForm() {
  ...
  if (document.forms["myForm"]["gardener_user_name"].value == "") {
  ...
  else if (document.forms["myForm"]["Re-Enter"].value == "") {
    alert("Re-Enter Password must be filled out");
    return false;
  }
  else if (document.forms["myForm"]["first_name"].value == "") {
    alert("First Name must be filled out");
    return false;
  }

  else if (document.forms["myForm"]["last_name"].value == "") {
    alert("Last Name must be filled out");
    return false;
  }
  else if (document.forms["myForm"]["gardener_bio"].value == "") {
    alert("Bio must be filled out");
    return false;
  }
  else if (document.forms["myForm"]["gardener_address"].value == "") {
    alert("Addresses must be filled out");
    return false;
  }
}
</script>
   ...
   <br>
      ...
      <form name="myForm" onsubmit="return validateForm()" action="login.php" method="get">
